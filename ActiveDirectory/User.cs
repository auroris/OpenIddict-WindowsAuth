...
namespace IdentityServer.ActiveDirectory
{
    ...
    public class User : ADObject
    {
        ...
        public String RankFR
        {
            get { return (String)base.adobject.Properties["extensionattribute2"].Value; }
            set { base.adobject.Properties["extensionattribute2"].Value = value.Length > 0 ? value : null; }
        }

        public String Level1En
        {
            get { return (String)base.adobject.Properties["extensionattribute1"].Value; }
            set { base.adobject.Properties["extensionattribute1"].Value = value.Length > 0 ? value : null; }
        }

        public String Level1Fr
        {
            get { return (String)base.adobject.Properties["extensionattribute7"].Value; }
            set { base.adobject.Properties["extensionattribute7"].Value = value.Length > 0 ? value : null; }
        }

        public String Level2En
        {
            get { return (String)base.adobject.Properties["division"].Value; }
            set { base.adobject.Properties["division"].Value = value.Length > 0 ? value : null; }
        }

        public String Level2Fr
        {
            get { return (String)base.adobject.Properties["extensionattribute3"].Value; }
            set { base.adobject.Properties["extensionattribute3"].Value = value.Length > 0 ? value : null; }
        }

        public String Level3En
        {
            get { return (String)base.adobject.Properties["section"].Value; }
            set { base.adobject.Properties["section"].Value = value.Length > 0 ? value : null; }
        }

        public String Level3Fr
        {
            get { return (String)base.adobject.Properties["extensionattribute8"].Value; }
            set { base.adobject.Properties["extensionattribute8"].Value = value.Length > 0 ? value : null; }
        }

        public String PositionEn
        {
            get { return (String)base.adobject.Properties["extensionattribute4"].Value; }
            set { base.adobject.Properties["extensionattribute4"].Value = value.Length > 0 ? value : null; }
        }

        public String PositionFr
        {
            get { return (String)base.adobject.Properties["extensionattribute6"].Value; }
            set { base.adobject.Properties["extensionattribute6"].Value = value.Length > 0 ? value : null; }
        }

        public String GeographicArea
        {
            get { return (String)base.adobject.Properties["extensionattribute5"].Value; }
            set { base.adobject.Properties["extensionattribute5"].Value = value.Length > 0 ? value : null; }
        }

        public String SN_PRI
        {
            get { return (String)base.adobject.Properties["extensionattribute10"].Value; }
            set { base.adobject.Properties["extensionattribute10"].Value = value.Length > 0 ? value : null; }
        }
        #endregion
